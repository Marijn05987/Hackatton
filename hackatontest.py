...
# Genereer een lijst van de meest voorkomende vliegtuigtypes
top_vliegtuigen = data['type'].value_counts().iloc[:20].index.tolist()
...
st.write("Gegenereerde vliegtuig_capaciteit_passagiersaantal:", vliegtuig_capaciteit_passagiersaantal)

# Voeg passagierscategorieën toe aan de dictionary
...
for vliegtuig, details in vliegtuig_capaciteit_passagiersaantal.items():
