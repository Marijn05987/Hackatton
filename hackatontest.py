...
@st.cache_data
def fetch_data():
    url = 'https://sensornet.nl/dataserver3/event/collection/nina_events/stream?conditions%5B0%5D%5B%5D=time&conditions%5B0%5D%5B%5D=%3E%3D&conditions%5B0%5D%5B%5D=1735689600&conditions%5B1%5D%5B%5D=time&conditions%5B1%5D%5B%5D=%3C&conditions%5B%5D%5B%5D=label&conditions%5B%5D%5B%5D=in&conditions%5B%5D%5B%5D=21&conditions%5B%5D%5B%5D=32&conditions%5B%5D%5B%5D=33&conditions%5B%5D%5B%5D=34&args%5B%5D=aalsmeer&args%5B%5D=schiphol&fields%5B%5D=time&fields%5B%5D=location_short&fields%5B%5D=location_long&fields%5B%5D=duration&fields%5B%5D=SEL&fields%5B%5D=SELd&fields%5B%5D=SELe&fields%5B%5D=SELn&fields%5B%5D=SELden&fields%5B%5D=SEL_dB&fields%5B%5D=lasmax_dB&fields%5B%5D=callsign&fields%5B%5D=type&fields%5B%5D=altitude&fields%5B%5D=distance&fields%5B%5D=winddirection&fields%5B%5D=windspeed&fields%5B%5D=label&fields%5B%5D=hex_s&fields%5B%5D=registration&fields%5B%5D=icao_type&fields%5B%5D=serial&fields%5B%5D=operator&fields%5B%5D=tags'
...
# Nieuwe grafiek per Passagierscategorie
st.subheader('Geluid per Passagier per Categorie')

# Voeg de passagierscategorieën toe
categories = {
    '50-100': (50, 100),
    '101-150': (101, 150),
    '151-200': (151, 200),
...
# Voeg een nieuwe kolom toe voor de passagierscategorie
resultaten['passagiers_categorie'] = pd.cut(resultaten['passagiers'], bins=[0, 100, 150, 200, 250, float('inf')], labels=['50-100', '101-150', '151-200', '201-250', '251+'])

# Maak de grafiek
fig, ax = plt.subplots(figsize=(10, 6))
sns.boxplot(x='passagiers_categorie', y='geluid_per_passagier', data=resultaten, palette='viridis', ax=ax)
ax.set_title('Geluid per Passagier per Categorie (Met Load Factor)', fontsize=14)
ax.set_xlabel('Passagierscategorie', fontsize=12)
